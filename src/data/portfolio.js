...
export const experience = [
  {
    ...
    company: "AlgoForge & AI Study Planner — Independent",
    duration: "2024 — Present",
    type: "AI Engineering",
    description: "Architected and shipped two production-grade AI-powered platforms. Applied LangChain RAG pipelines, OpenAI & Gemini APIs to deliver measurable real-world results — reducing AI errors by 40% and validation failures by 35%.",
    highlights: [
      "Built RAG architecture reducing irrelevant AI responses by 40%",
      "Engineered multi-language AI code evaluation pipeline",
      "Integrated OpenAI, Gemini API & LangChain into production systems",
      "Achieved 35% reduction in solution validation errors",
      "Designed scalable Dockerized microservices for AlgoForge",
    ],
    tech: ["LangChain", "RAG", "OpenAI API", "Gemini API", "FastAPI", "Docker"],
    impact: "40% reduction in AI errors",
    growth: "Became proficient in production-grade AI system design",
    color: "#10b981",
  },
  {
    id: 2,
    ...
    type: "Engineering",
    description: "Built scalable MERN stack web applications from the ground up — handling everything from system architecture and REST API design to authentication flows, database optimization, and deployment pipelines.",
    highlights: [
      "Architected MERN stack applications with Node.js & Express.js",
      "Implemented JWT & Google OAuth 2.0 authentication systems",
      "Designed MongoDB schemas for real-time analytics dashboards",
      "Built responsive UIs with React, Tailwind CSS & Chart.js",
      "Deployed production apps with Vercel and Docker compose",
    ],
    tech: ["React", "Node.js", "Express.js", "MongoDB", "JWT", "Tailwind CSS"],
    impact: "2 production applications shipped",
    growth: "Mastered end-to-end full-stack system architecture",
    color: "#7c3aed",
  },
  {
    id: 3,
    title: "Competitive Programmer",
    company: "LeetCode · GeeksforGeeks · CodeChef",
    duration: "2023 — Present",
    type: "Algorithmic Excellence",
    description: "Consistently performing in the top percentile across global competitive programming platforms. Achieved Knight rank on LeetCode with 1907 rating — a marker of elite algorithmic problem-solving capability.",
    highlights: [
      "LeetCode Knight — Rating 1907, Top 4.23% globally",
      "Contest Rank 496 among 30,000+ participants",
      "500+ problems solved across LeetCode, GFG, CodeChef",
      "GeeksforGeeks 3-Star · Rating 1819 · Top 4% at institute",
      "Strong in DP, Graphs, Trees, Greedy & String algorithms",
    ],
    tech: ["C++", "Python", "DSA", "Dynamic Programming", "Graph Theory"],
    impact: "Top 4.23% globally on LeetCode",
    growth: "Developed rigorous systems-level thinking under pressure",
    color: "#f59e0b",
  },
  {
    id: 4,
    title: "Computer Science Engineer",
    company: "Techno Main Salt Lake, Kolkata",
    duration: "2023 — 2027",
    type: "Education",
    description: "Pursuing B.Tech in Computer Science & Engineering with a CGPA of 8.0/10. Grounding academic fundamentals in systems, algorithms, and software engineering while simultaneously building real-world engineering projects.",
    highlights: [
      "CGPA: 8.0 / 10 — consistent academic performer",
      "WBJEE 2023 AIR 7042 — Top 6% among 120,000 candidates",
      "NPTEL Elite + Gold in Java (93%) and DBMS (71%)",
      "AWS Cloud Practitioner Certified",
      "Core coursework: DSA, DBMS, OS, OOP, Software Engineering",
    ],
    tech: ["Java", "C++", "DBMS", "Operating Systems", "Software Engineering"],
    impact: "WBJEE AIR 7042 — Top 6% nationally",
    growth: "Built strong CS fundamentals powering all engineering work",
    color: "#00d4ff",
  },
];
